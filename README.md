...
alerts:
  ...
  observe:
    percentile_threshold: 90   # 观察提醒阈值
  important:
    percentile_threshold: 90   # 重要提醒阈值
    min_dimensions: 3          # 最少异常维度数
...
- [设计文档](docs/DESIGN.md)
- [重构计划](docs/plans/2026-02-01-binance-refactor-impl.md)
